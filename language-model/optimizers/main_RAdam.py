...
if __name__ == '__main__':
    ...
    optimizer = RAdam(net.parameters(), lr=0.003) #100 done
    ...
    for epoch in xrange(nepoch):
        ...
        if epoch == 81:
            ...
            optimizer = RAdam(net.parameters(), lr=0.0003) #500 done
        elif epoch ==122:
            #optimizer = AdamW(net.parameters(), lr=0.00003, iter_count=iter_count, restarting_iter=200) #1000 done
            optimizer = RAdam(net.parameters(), lr=0.00003) #1000 done
        elif epoch ==186:
            #optimizer = AdamW(net.parameters(), lr=0.00003, iter_count=iter_count, restarting_iter=200) #1000 done
            optimizer = RAdam(net.parameters(), lr=0.000003) #1000 done
