...
if __name__ == '__main__':
    ...
    optimizer = SRRAdam(net.parameters(), lr=0.003, iter_count=iter_count, restarting_iter=60) #20, 10
    ...
    for epoch in xrange(nepoch):
        ...
        if epoch == 81:
            optimizer = SRRAdam(net.parameters(), lr=0.0003, iter_count=iter_count, restarting_iter=120) #40, 20
        elif epoch ==122:
            optimizer = SRRAdam(net.parameters(), lr=0.00003, iter_count=iter_count, restarting_iter=180) #80, 30
        elif epoch ==188:
            optimizer = SRRAdam(net.parameters(), lr=0.000003, iter_count=iter_count, restarting_iter=240) #160, 40
