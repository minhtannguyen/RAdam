...
parser.add_argument('--model_name', default='Basic-LSTM')
    ...
    try:
        for indexs in range(args.epoch):
            ...
            for word_t, label_t in iterator:
                ...
                if args.update.lower() == 'sradamw' or args.update.lower() == 'srradam':
                ...
                if 0 == batch_index % args.interval:
                    ...
                    writer.add_scalars('train_loss', {args.model_name: s_loss}, batch_index)
                ...
                if 0 == batch_index % args.check_interval:
                    ...
                    writer.add_scalars('train_ppl', {args.model_name: epoch_ppl}, batch_index)
            ...
            writer.add_scalars('test_ppl', {args.model_name: test_ppl}, indexs)
        ...
        test_ppl = evaluate(test_loader, lm_model, test_lm, -1)
        writer.add_scalars('test_ppl', {args.model_name: test_ppl}, args.epoch)
