...
__all__ = ['mompreresnet_learned_v2_vo0']
...
class BasicBlock(nn.Module):
    ...
    def __init__(self, inplanes, planes, stride=1, downsample=None, eta=1.0):
        ...
        self.stride = stride
        self.eta = Parameter(torch.ones(1,inplanes,1,1), requires_grad=True)
...
def mompreresnet_learned_v2_vo0(**kwargs):
    """
    Constructs a ResNet model.
    """
    return MOMPreResNet(**kwargs)
