...
def preact_resnet20(**kwargs):
    return PreResNet(num_classes=10,
                   depth=20,
...
def preact_resnet290(**kwargs):
    return PreResNet(num_classes=10,
                   depth=290,
                   block_name="bottleneck")
		   #block_name="basicblock")

def preact_resnet470(**kwargs):
    return PreResNet(num_classes=10,
                   depth=470,
                   block_name="bottleneck")
		   #block_name="basicblock")
def preact_resnet650(**kwargs):
    return PreResNet(num_classes=10,
                   depth=650,
                   block_name="bottleneck")
		   #block_name="basicblock")
def preact_resnet830(**kwargs):
    return PreResNet(num_classes=10,
                   depth=830,
                   block_name="bottleneck")
		   #block_name="basicblock")
