...
from momentum_nets_learned_scalar_block_uniform import *
from utils import *
...
#             if not os.path.isdir('checkpoint_Cifar_momentum_net_learned_scalar_block_uniform'):
#                 os.mkdir('checkpoint_Cifar_momentum_net_learned_scalar_block_uniform')
#             torch.save(state, './checkpoint_Cifar_momentum_net_learned_scalar_block_uniform/ckpt_momentum_net_learned_scalar_block_uniform.t7')
            best_acc = acc
